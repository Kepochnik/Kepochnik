/**
 * SHA-256, needed because Solana derives program addresses with it. Written
 * out here for the same reason keccak is: this package has no runtime
 * dependencies, and a hash is a page of arithmetic with published test vectors.
 */
